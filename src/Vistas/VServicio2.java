...
public class VServicio2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton5.setBorder(javax.swing.BorderFactory.createEmptyBorder(4, 16, 4, 16));
        jButton5.setBorderPainted(false);
        jButton5.setMaximumSize(new java.awt.Dimension(77, 24));
        jButton5.setMinimumSize(new java.awt.Dimension(77, 24));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VServicio2().setVisible(true);
            }
        });
    }
